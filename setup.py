...
setup(
    ...
    zip_safe=False,
    install_requires=(
        # Project requirements (semi-pinned)
        "django<2.3",  # Django 2.2 LTS - https://github.com/django/django
        "django-autoslug<2",  # https://github.com/justinmayer/django-autoslug
        "django-model-utils<4",  # https://github.com/jazzband/django-model-utils
    ),
    extras_require={
        "test": (
            # Test requirements
