# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-20 05:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='last modification time')),
                ('slug', autoslug.fields.AutoSlugField(editable=False, max_length=255, populate_from=popolo.behaviors.models.get_slug_source, slugify=django.utils.text.slugify, unique=True)),
                ('name', models.CharField(blank=True, help_text='A primary name', max_length=256, null=True, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='creation time')),
                ('updated_at', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='last modification time')),
                ('n_eligible_voters', models.PositiveIntegerField(help_text='The total number of eligible voter', null=True, verbose_name='Total number of eligible voters')),
                ('n_ballots', models.PositiveIntegerField(help_text='The total number of ballots casted', null=True, verbose_name='Total number of ballots casted')),
                ('perc_turnout', models.FloatField(help_text='The percentage of eligible voters that casted a ballot', null=True, validators=[popolo.validators.validate_percentage], verbose_name='Voter turnout')),
                ('perc_valid_votes', models.FloatField(help_text='The percentage of valid votes among those cast', null=True, validators=[popolo.validators.validate_percentage], verbose_name='Valid votes perc.')),
                ('perc_null_votes', models.FloatField(help_text='The percentage of null votes among those cast', null=True, validators=[popolo.validators.validate_percentage], verbose_name='Null votes perc.')),
                ('perc_blak_votes', models.FloatField(help_text='The percentage of blank votes among those cast', null=True, validators=[popolo.validators.validate_percentage], verbose_name='Blank votes perc.')),
                ('n_preferences', models.PositiveIntegerField(help_text='The total number of preferences expressed for the list/candidate', null=True, verbose_name='Total number of preferences')),
                ('perc_preferences', models.FloatField(help_text='The percentage of preferences expressed for the list/candidate', null=True, validators=[popolo.validators.validate_percentage], verbose_name='Preference perc.')),
        ...
        migrations.AddField(
            ...
            name='candidate',
            field=models.ForeignKey(blank=True, help_text='The candidate in the election these data are valid for', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='electoral_results', to='popolo.Person', verbose_name='Candidate'),
        ),
        migrations.AddField(
            model_name='electoralresult',
            name='constituency',
            field=models.ForeignKey(blank=True, help_text='The electoral constituency these electoral data are valid for', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='electoral_results', to='popolo.Area', verbose_name='Electoral constituency'),
        ),
        migrations.AddField(
            model_name='electoralresult',
            name='event',
        ...
        migrations.AddField(
            model_name='electoralresult',
            name='list',
            field=models.ForeignKey(blank=True, help_text='The electoral list these electoral data are valid for', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='list_electoral_results', to='popolo.Organization', verbose_name='Electoral list'),
        ),
        migrations.AddField(
            model_name='electoralresult',
            name='organization',
            field=models.ForeignKey(help_text='The institution these electoral data are valid for', on_delete=django.db.models.deletion.CASCADE, related_name='general_electoral_results', to='popolo.Organization', verbose_name='Institution'),
        ),
        migrations.AddField(
