# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-10-18 18:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(popolo.models.SourceShortcutsMixin, popolo.models.IdentifierShortcutsMixin, popolo.models.OtherNamesShortcutsMixin, models.Model),
        ),
        migrations.CreateModel(
            name='AreaI18Name',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='creation time')),
                ('updated_at', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='last modification time')),
                ('classification', models.CharField(help_text='The relationship classification, ex: other_parent, ...', max_length=255)),
                ('note', models.TextField(blank=True, help_text='Additional info about the relationship', null=True)),
                ('dest_area', models.ForeignKey(help_text='The Area the relationship ends to', on_delete=django.db.models.deletion.CASCADE, related_name='from_relationships', to='popolo.Area', verbose_name='Destination area')),
                ('source_area', models.ForeignKey(help_text='The Area the relation starts from', on_delete=django.db.models.deletion.CASCADE, related_name='to_relationships', to='popolo.Area', verbose_name='Source area')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_places', models.ManyToManyField(blank=True, help_text='Link to organization(s) after dissolution_date, needed to track mergers, acquisition, splits.', related_name='old_places', to='popolo.Organization')),
        ...
        migrations.AddField(
            model_name='area',
            name='relationships',
            field=models.ManyToManyField(help_text='Relationships between areas', related_name='related_to', through='popolo.AreaRelationship', to='popolo.Area'),
        ),
