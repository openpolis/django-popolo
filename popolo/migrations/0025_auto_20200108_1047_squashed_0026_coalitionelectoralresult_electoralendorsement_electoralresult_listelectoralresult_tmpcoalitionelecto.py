# Generated by Django 2.2.9 on 2020-01-08 10:49
...
class Migration(migrations.Migration):
    ...
    replaces = [('popolo', '0025_auto_20200108_1047'), ('popolo', '0026_coalitionelectoralresult_electoralendorsement_electoralresult_listelectoralresult_tmpcoalitionelecto')]

    dependencies = [
        ('popolo', '0024_coalitionelectoralresult_electoralendorsement_electoralresult_listelectoralresult_tmpcoalitionelecto_squashed_0027_coalitionelectoralresult_electoralendorsement_electoralresult_listelectoralresult_tmpcoalitionelecto'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constituency', models.ForeignKey(help_text='The official area of a country that elects a representative (as to a legislative or executive position).(e.g. an electoral district).', on_delete=django.db.models.deletion.CASCADE, related_name='electoral_result', to='popolo.Area', verbose_name='constituency')),
                ...
                ('institution', models.ForeignKey(help_text='The formal organization this electoral result refers to', on_delete=django.db.models.deletion.CASCADE, related_name='electoral_result', to='popolo.Organization', verbose_name='institution')),
            ],
            options={
